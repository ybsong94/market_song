...
<title>MarkrtSONG My Information</title>
...
<div class="container">
  ...
  <div class="row">
    ...
    <div class="col-md-8 order-md-1">
      ...
      <form class="needs-validation" action="updateUser.do" method="post" enctype="multipart/form-data">

        <div class="mb-3">
          <label for="id">ID</label>
          <input type="text" class="form-control" id="id" placeholder="${userVO.id}" name="id" readonly>
        </div>
