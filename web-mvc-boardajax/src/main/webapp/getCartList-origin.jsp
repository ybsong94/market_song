...
<%for(CartVO cart : cartList){ %>
    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <h5>Cart No [<%=cart.getCartNo() %>]</h5>
            ...
            <form class="form-inline" action="updateCart.do" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" class="btn btn-primary">수량 변경하기</button>
            </form>
	...
	<div class="form-group">
		...
		<form class="form-inline" action="deleteCart.do" method="post" enctype="multipart/form-data">
        	<input type="hidden" class="form-control" id="cartNo" name="cartNo" value="<%=cart.getCartNo()%>">
        	<input type="hidden" class="form-control" id="uno" name="uno" value="<%=cart.getUno()%>">
			<br>
			&nbsp;
				<span class="glyphicon glyphicon-chevron-right">
